...
contract BCI is ERC20, Ownable {
    ...
    address private RewardToken =
        address(0x420FcA0121DC28039145009570975747295f2329); //RewardToken

    uint256 public swapTokensAtAmount = 2 * 10**6 * (10**18);
    uint256 public maxBuyAmount = 694200000000 * 10**18;
    uint256 public maxSellAmount = 347100000000 * 10**18;
    uint256 public maxWalletAmount = 694200000000 * 10**18;
    ...
    constructor() ERC20("Baby Coq Inu", "BCI") {
        ...
        */
        _mint(owner(), 69420000000000 * (10**18));
    }
